...
export const MAP_LOD_MODEL_PATHS = {
  ebike: assetUrl("/models/ebike-LOD/model.gltf"),
  eolienne: assetUrl("/models/eolienne-LOD/model.gltf"),
  pylone: assetUrl("/models/pylone-LOD/model.gltf"),
  boiteimmeuble: assetUrl("/models/boiteimmeuble-LOD/model.gltf"),
  ecole: assetUrl("/models/ecole-LOD/model.gltf"),
  immeuble1: assetUrl("/models/immeuble1-LOD/model.gltf"),
  lafabrik: assetUrl("/models/lafabrik-LOD/model.gltf"),
  maison1: assetUrl("/models/maison1-LOD/model.gltf"),
  panneauaffichage: assetUrl("/models/panneauaffichage-LOD/model.gltf"),
  arbre: assetUrl("/models/arbre-LOD/model.glb"),
  buisson: assetUrl("/models/buisson-LOD/model.glb"),
  sapin: assetUrl("/models/sapin-LOD/model.glb"),
