...
export const REPAIR_MISSIONS: Record<RepairMissionId, RepairMissionConfig> = {
  ebike: {
    ...
    modelPath: assetUrl("/models/ebike/model.gltf"),
    ...
    brokenParts: [
      {
        ...
        label: "Cooling core",
        modelPath: assetUrl("/models/refroidisseur/model.gltf"),
        nodeName: "Radiateur",
    ...
    replacementParts: [
      ...
      },
      {
        ...
        label: "Câble droit",
        modelPath: assetUrl("/models/cable1/model.gltf"),
        caseAnchor: "cabledroit",
      },
      {
        id: "ebike-cable-left-distractor",
        label: "Câble gauche",
        modelPath: assetUrl("/models/cable2/model.gltf"),
        caseAnchor: "cablegauche",
      },
      {
        id: "ebike-puce-haut-distractor",
        label: "Puce haute",
        modelPath: assetUrl("/models/puce/model.gltf"),
        caseAnchor: "pucehaut",
      },
      {
  ...
  farm: {
    ...
    modelPath: assetUrl("/models/fermeverticale/model.gltf"),
